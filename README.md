...
- Whenever someone opens a short URL a set of visits is stored (number of calls, date and time, user agent, referrer, etc.).
- These visits can be retrieved via the Web Service API.
